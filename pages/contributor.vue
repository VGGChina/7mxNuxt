...
<script>
import IdentityInfo from '~/components/contributor_children/IdentityInfo'
import ApplyNotes from '~/components/contributor_children/ApplyNotes'
import GoodAt from '~/components/contributor_children/good-at/GoodAt'
import WaitExamine from '~/components/contributor_children/wait-examine/WaitExamine'
