  ...
  <div>
    ...
    <div v-for="(item, index) in commentList"
      ...
      <span>{{ item.user_data.nick || item.user_data.name }}
        <span class="reply" v-if="item.to_comment == '1'">回复</span>
...
export default {
  ...
  mounted() {
    let input = document.getElementById('userFollowConmmentInput' + this.index);
    input.onfocus = () => {
      this.isFocus = true;
    }
