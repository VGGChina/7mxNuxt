...
<div class="top-nav-container">
    <div  class="top-nav-content">
        ...
        <div class="right-text">
            ...
            <i>{{active_list.start_time | timeForamt }}-{{active_list.close_time | timeForamt}}</i>
...
export default {
  ...
  computed: {
    ...
    'match_actiove': function() {
      if (this.active_list.close_time) {
        let content = new Date().getTime() / 1000 - this.active_list.close_time <= 0 ? '我要参赛' : '活动已结束'
        return content
      }
    }
  }
